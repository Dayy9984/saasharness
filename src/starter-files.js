...
export function starterFiles(plan, contractRaw) {
  ...
  const files = {
    ...
    'wrangler.jsonc': `${JSON.stringify({ $schema: 'node_modules/wrangler/config-schema.json', name: plan.product.name, compatibility_date: '2026-08-01', main: './src/worker/index.ts', observability: { enabled: true }, assets: { not_found_handling: 'single-page-application' } }, null, 2)}\n`,
